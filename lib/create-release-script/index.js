...
const createReleaseScript = async ({ version, components, deployment, deployFilePath, deployTemplateFilePath, releaseJsonPath }) => {
    
    const deployHeader = generateHeader(version, components, deployment, releaseJsonPath)
...
const generateHeader = (version, components, deployment, releaseJsonPath) => {
  var headerLines = [];
