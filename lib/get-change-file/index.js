...
const run = async () => {
  try {
    ...
    else if (!changeFile.incrementation) core.setFailed('An incrementation type has not been set in the change file. Please add a valid incrementation type: major | minor | patch.')
    else {
      
      const changeFile = changeFiles[0];
