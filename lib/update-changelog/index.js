...
const run = () => {
  try {
    ...
    //const packageFile = require('./dummy-repo/package.json');
    //const packageFile = require("/home/runner/work/dummy-repo/dummy-repo/CHANGELOG.md");
    //var packagejsonpath = path.resolve(__dirname, 'package.json');
    console.log('changelog path: ' + changelog_abspath);
    console.log('package jsonL ' + packagejson);
    //console.log('dirname path: ' + __dirname); //this is the path to script: /home/runner/work/_actions/15gifts/actions/Add_update-changelog_script/lib/update-changelog
    //console.log('packagejsonpath path: ' + packagejsonpath);
    //console.log('import package relative', packageFile)
